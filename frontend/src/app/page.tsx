      ...
      <main className="max-w-md mx-auto px-4 py-6">
        ...
        {currentList ? (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-black">Current List</h2>
          ...
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold text-black mb-2">No Shopping List</h2>
            <p className="text-black mb-6">Create a new shopping list to get started</p>
            <button
        ...
        {/* Products Section */}
        <div className="mt-8">
          <h2 className="text-lg font-semibold text-black mb-4">Available Products</h2>
          <div className="bg-white rounded-lg shadow-sm border">
            {products.length > 0 ? (
              <div className="divide-y">
